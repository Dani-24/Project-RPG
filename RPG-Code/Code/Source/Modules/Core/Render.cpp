...
// Blit to screen
bool Render::DrawTexture(SDL_Texture* texture, int x, int y, const SDL_Rect* section , int zoom ,float speed, double angle, int pivotX, int pivotY) const
{
	bool ret = true;
...
bool Render::DrawTexture2(SDL_Texture* texture, int x, int y, int zoom, float scale, bool flipH, SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y)
{
	bool ret = true;
	SDL_Rect rect;
	rect.x = (int)(app->camera->GetPos().x * speed) + x * scale;
